...
/***/ "../../../../../src/app/pages/model/mentioncount.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
class MentionCount {
    constructor(twitterUserId, mentionsLastWeek) {
        this.twitterUserId = twitterUserId;
        this.mentionsLastWeek = mentionsLastWeek;
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = MentionCount;

//# sourceMappingURL=mentioncount.model.js.map

/***/ }),

/***/ "../../../../../src/app/pages/model/politician.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = PoliticianModel;

//# sourceMappingURL=politician.model.js.map

/***/ }),

/***/ "../../../../../src/app/pages/model/rawmention.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
class RawMention {
    constructor(tweetId, twitterUserId, createdAt) {
        this.tweetId = tweetId;
        this.twitterUserId = twitterUserId;
        this.createdAt = createdAt;
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = RawMention;

//# sourceMappingURL=rawmention.model.js.map

/***/ }),

/***/ "../../../../../src/app/pages/model/rawsentiment.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
class RawSentiment {
    constructor(twitterUserId, sentimentLabel, sentimentScore, createdAt) {
        this.twitterUserId = twitterUserId;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RawSentiment;

//# sourceMappingURL=rawsentiment.model.js.map

/***/ }),

/***/ "../../../../../src/app/pages/shared/diagrams/mentions/mentions-transformer.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tableData__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/mentions/tableData.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment__ = __webpack_require__("../../../../moment/moment.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ramda__ = __webpack_require__("../../../../ramda/index.js");
...
let MentionsTransformerService = class MentionsTransformerService {
    constructor() {
        this.amountOfDays = 30;
    }
    orderedSumPerDay(mentions) {
        const today = new Date();
        const resultMap = this.createEmptyTableData(today);
        for (const mention of mentions) {
            this.incrementMentionForDay(resultMap, new Date(mention.createdAt));
        }
        return this.convertMapToOrderedArray(resultMap);
    }
    convertMapToOrderedArray(resultMap) {
        const result = [];
        resultMap.forEach((value, key) => result.push(new __WEBPACK_IMPORTED_MODULE_1__tableData__["a" /* TableData */](new Date(key), value)));
        __WEBPACK_IMPORTED_MODULE_3_ramda__["sort"]((a, b) => a.date.valueOf() - b.date.valueOf(), result);
        return result;
    }
    createEmptyTableData(today) {
        const result = new Map();
        for (let day = this.amountOfDays; day > 0; day--) {
            const aDate = __WEBPACK_IMPORTED_MODULE_2_moment__(today).add(-day, 'days');
            result.set(this.truncateDateToDate(aDate.toDate()).valueOf(), 0);
        }
        return result;
    }
    truncateDateToDate(date) {
        return new Date(date.getFullYear(), date.getMonth(), date.getDate());
    }
    incrementMentionForDay(resultMap, date) {
        const time = this.truncateDateToDate(date).valueOf();
        const mentions = resultMap.get(time);
...
/***/ "../../../../../src/app/pages/shared/diagrams/mentions/mentions.component.scss":
...
/***/ "../../../../../src/app/pages/shared/diagrams/mentions/mentions.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__theme__ = __webpack_require__("../../../../../src/app/theme/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__theme_theme_configProvider__ = __webpack_require__("../../../../../src/app/theme/theme.configProvider.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_mentions_service__ = __webpack_require__("../../../../../src/app/pages/shared/services/mentions.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__queryHelper__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/queryHelper.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ramda__ = __webpack_require__("../../../../ramda/index.js");
...
let MentionsComponent = class MentionsComponent {
    constructor(mentionsDataService, baconfig) {
    ...
    loadData() {
        this.mentionsDataService.getMentionsAggregateForLastMonth(this.queryHelper.createQueryString(this.party, this.politicianId)).subscribe((mentionsAggregate) => {
            if (this.chart) {
                this.chart.dataProvider = __WEBPACK_IMPORTED_MODULE_6_ramda__["sort"]((a, b) => a.date.valueOf() - b.date.valueOf(), mentionsAggregate);
...
MentionsComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/pages/shared/diagrams/mentions/mentions.component.html"),
        styles: [__webpack_require__("../../../../../src/app/pages/shared/diagrams/mentions/mentions.component.scss")],
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__services_mentions_service__["a" /* MentionsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__services_mentions_service__["a" /* MentionsService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__theme_theme_configProvider__["a" /* BaThemeConfigProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__theme_theme_configProvider__["a" /* BaThemeConfigProvider */]) === "function" && _b || Object])
], MentionsComponent);
...
/***/ "../../../../../src/app/pages/shared/diagrams/mentions/tableData.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = TableData;

//# sourceMappingURL=tableData.js.map

/***/ }),

/***/ "../../../../../src/app/pages/shared/diagrams/queryHelper.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_queryBuilder__ = __webpack_require__("../../../../../src/app/pages/shared/services/queryBuilder.ts");

class QueryHelper {
    constructor() {
        this.queryBuilder = new __WEBPACK_IMPORTED_MODULE_0__services_queryBuilder__["a" /* QueryBuilder */]();
    }
    createQueryString(party, politicianId) {
        if (party) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = QueryHelper;

//# sourceMappingURL=queryHelper.js.map

/***/ }),

/***/ "../../../../../src/app/pages/shared/diagrams/sentiments/sentiments-transformer.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ramda__ = __webpack_require__("../../../../ramda/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ramda___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_ramda__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tableData__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/sentiments/tableData.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__truncateDate__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/truncateDate.ts");
...
let SentimentsTransformerService = class SentimentsTransformerService {
    constructor() {
        this.amountOfDays = 30;
        this.truncateDate = new __WEBPACK_IMPORTED_MODULE_3__truncateDate__["a" /* TruncateDate */]();
    }
    orderedSumPerDay(rawSentiments) {
        const today = new Date();
        const resultMap = this.createEmptyTableData(today);
    ...
    convertMapToOrderedArray(resultMap) {
        ...
        resultMap.forEach((value, key) => {
            const positive = __WEBPACK_IMPORTED_MODULE_1_ramda__["mean"](value.positive);
            const positiveCount = value.positive.length;
            const negative = __WEBPACK_IMPORTED_MODULE_1_ramda__["mean"](value.negative);
            const negativeCount = value.negative.length;
            result.push(new __WEBPACK_IMPORTED_MODULE_2__tableData__["a" /* TableData */](new Date(key), positive, negative, ((positiveCount * positive) + (negativeCount * negative)) / (positiveCount + negativeCount)));
        });
        __WEBPACK_IMPORTED_MODULE_1_ramda__["sort"]((a, b) => a.date.valueOf() - b.date.valueOf(), result);
        return result;
    }
    createEmptyTableData(today) {
        const result = new Map();
        for (let day = this.amountOfDays; day > 0; day--) {
            const aDate = __WEBPACK_IMPORTED_MODULE_4_moment__(today).add(-day, 'days');
            result.set(this.truncateDate.truncateDateToDate(aDate.toDate()).valueOf(), new Values());
        }
        return result;
    }
    addSentimentValueToDay(resultMap, sentiment) {
        const time = this.truncateDate.truncateDateToDate(sentiment.createdAt).valueOf();
        const mapEntry = resultMap.get(time);
        if (mapEntry) {
...
/***/ "../../../../../src/app/pages/shared/diagrams/sentiments/sentiments.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/pages/shared/diagrams/sentiments/sentiments.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__theme__ = __webpack_require__("../../../../../src/app/theme/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__theme_theme_configProvider__ = __webpack_require__("../../../../../src/app/theme/theme.configProvider.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_sentiments_service__ = __webpack_require__("../../../../../src/app/pages/shared/services/sentiments.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sentiments_transformer_service__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/sentiments/sentiments-transformer.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__queryHelper__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/queryHelper.ts");
...
let SentimentsComponent = class SentimentsComponent {
    constructor(sentimentDataService, sentimentTransformerService, baconfig) {
        this.queryHelper = new __WEBPACK_IMPORTED_MODULE_5__queryHelper__["a" /* QueryHelper */]();
...
SentimentsComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/pages/shared/diagrams/sentiments/sentiments.component.html"),
        styles: [__webpack_require__("../../../../../src/app/pages/shared/diagrams/sentiments/sentiments.component.scss")],
    }),
...
/***/ "../../../../../src/app/pages/shared/diagrams/sentiments/tableData.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
class TableData {
    constructor(date, positive, negative, mean) {
        this.date = date;
...
/***/ "../../../../../src/app/pages/shared/diagrams/truncateDate.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = TruncateDate;

//# sourceMappingURL=truncateDate.js.map

/***/ }),

/***/ "../../../../../src/app/pages/shared/feed/feed.component.html":
/***/ (function(module, exports) {

module.exports = "<ba-card cardTitle=\"Feed\"\r\n         baCardClass=\"large-card with-scroll feed-panel\">\r\n  <div class=\"feed\"></div>\r\n</ba-card>\r\n\r\n"

/***/ }),

/***/ "../../../../../src/app/pages/shared/feed/feed.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/pages/shared/feed/feed.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* Input */])(),
    __metadata("design:type", Object)
], Feed.prototype, "twitterName", void 0);
Feed = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Component */])({
        selector: 'feed',
        template: __webpack_require__("../../../../../src/app/pages/shared/feed/feed.component.html"),
        styles: [__webpack_require__("../../../../../src/app/pages/shared/feed/feed.component.scss")],
    }),
...
/***/ "../../../../../src/app/pages/shared/seat/seat.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_mapping__ = __webpack_require__("../../../../../src/app/pages/util/mapping.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__service_seat_service__ = __webpack_require__("../../../../../src/app/pages/shared/seat/service/seat.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__util_helper_service__ = __webpack_require__("../../../../../src/app/pages/util/helper.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_tile_tile_service__ = __webpack_require__("../../../../../src/app/pages/shared/tile/tile.service.ts");
...
let SeatComponent = class SeatComponent {
    constructor(seatService, route, router, helperService, modalService, tileService) {
        ...
        this.tileService.getMostActiveUsers(100).subscribe((data) => {
            ...
            this.seats.forEach(seat => {
                ...
                if (seat.mappingIndex !== -1) {
                    seat.party = __WEBPACK_IMPORTED_MODULE_2__util_mapping__["a" /* MAPPING */][seat.mappingIndex].party;
                    seat.twitterId = __WEBPACK_IMPORTED_MODULE_2__util_mapping__["a" /* MAPPING */][seat.mappingIndex].id;
                    seat.name = __WEBPACK_IMPORTED_MODULE_2__util_mapping__["a" /* MAPPING */][seat.mappingIndex].name;
                    seat.number = __WEBPACK_IMPORTED_MODULE_2__util_mapping__["a" /* MAPPING */][seat.mappingIndex].number;
                }
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* Input */])(),
    __metadata("design:type", String)
], SeatComponent.prototype, "councilFilter", void 0);
SeatComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Component */])({
        selector: 'app-seat',
        template: __webpack_require__("../../../../../src/app/pages/shared/seat/seat.html"),
        styles: [__webpack_require__("../../../../../src/app/pages/shared/seat/seat.scss")],
        providers: [__WEBPACK_IMPORTED_MODULE_3__service_seat_service__["a" /* SeatService */]],
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__service_seat_service__["a" /* SeatService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__service_seat_service__["a" /* SeatService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__util_helper_service__["a" /* Helper */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__util_helper_service__["a" /* Helper */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_6__ng_bootstrap_ng_bootstrap__["c" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__ng_bootstrap_ng_bootstrap__["c" /* NgbModal */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_5__shared_tile_tile_service__["a" /* TileService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__shared_tile_tile_service__["a" /* TileService */]) === "function" && _f || Object])
], SeatComponent);
...
/***/ "../../../../../src/app/pages/shared/seat/seat.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/pages/shared/seat/service/seat.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__seatSr_data__ = __webpack_require__("../../../../../src/app/pages/shared/seat/service/seatSr.data.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__seatNr_data__ = __webpack_require__("../../../../../src/app/pages/shared/seat/service/seatNr.data.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__seatBv_data__ = __webpack_require__("../../../../../src/app/pages/shared/seat/service/seatBv.data.ts");
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SeatService; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let SeatService = class SeatService {
    ...
    getSeats(councilFilter) {
        if (councilFilter === 'SR') {
            return __WEBPACK_IMPORTED_MODULE_1__seatSr_data__["a" /* SEATSSR */];
        }
        if (councilFilter === 'NR') {
            return __WEBPACK_IMPORTED_MODULE_2__seatNr_data__["a" /* SEATSNR */];
        }
        return __WEBPACK_IMPORTED_MODULE_3__seatBv_data__["a" /* SEATSBV */];
    }
};
...
/***/ "../../../../../src/app/pages/shared/seat/service/seatBv.data.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SEATSBV;

//# sourceMappingURL=seatBv.data.js.map

/***/ }),

/***/ "../../../../../src/app/pages/shared/seat/service/seatNr.data.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SEATSNR;

//# sourceMappingURL=seatNr.data.js.map

/***/ }),

/***/ "../../../../../src/app/pages/shared/seat/service/seatSr.data.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SEATSSR;

//# sourceMappingURL=seatSr.data.js.map

/***/ }),

/***/ "../../../../../src/app/pages/shared/services/mentions.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_config_constants__ = __webpack_require__("../../../../../src/app/app-config.constants.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_config_interface__ = __webpack_require__("../../../../../src/app/app-config.interface.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__model_rawmention_model__ = __webpack_require__("../../../../../src/app/pages/model/rawmention.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__model_mentioncount_model__ = __webpack_require__("../../../../../src/app/pages/model/mentioncount.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ramda__ = __webpack_require__("../../../../ramda/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ramda___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_ramda__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__diagrams_mentions_tableData__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/mentions/tableData.ts");
...
let MentionsService = class MentionsService {
    constructor(http, helper, config) {
        this.http = http;
        this.helper = helper;
        this.config = config;
    }
    getMentions(query) {
        return this.http.get(`${this.config.BACKEND_URL}/mentions${query}`)
            ...
            .map((mentions) => __WEBPACK_IMPORTED_MODULE_9_ramda__["map"]((mention) => new __WEBPACK_IMPORTED_MODULE_7__model_rawmention_model__["a" /* RawMention */](mention.tweetId, mention.twitterUserId, new Date(mention.createdAt)), mentions))
            .catch(this.helper.handleError);
    }
    getMentionCountsForLastWeek() {
        return this.http.get(`${this.config.BACKEND_URL}/mentions/countLastWeek`)
            .map(this.helper.extractData)
            .map((dataInHolder) => dataInHolder.counts)
            .map((counts) => __WEBPACK_IMPORTED_MODULE_9_ramda__["map"](count => new __WEBPACK_IMPORTED_MODULE_8__model_mentioncount_model__["a" /* MentionCount */](count._id, count.count), counts))
            .catch(this.helper.handleError);
    }
    getMentionsAggregateForLastMonth(query) {
        return this.http.get(`${this.config.BACKEND_URL}/mentions/count${query}`)
            .map(this.helper.extractData)
            .map((dataInHolder) => dataInHolder.count)
            .map((counts) => __WEBPACK_IMPORTED_MODULE_9_ramda__["map"](count => new __WEBPACK_IMPORTED_MODULE_10__diagrams_mentions_tableData__["a" /* TableData */](new Date(count._id.year, count._id.month - 1, count._id.day), count.count), counts))
            .catch(this.helper.handleError);
    }
};
MentionsService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["d" /* Injectable */])(),
    __param(2, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["g" /* Inject */])(__WEBPACK_IMPORTED_MODULE_3__app_config_constants__["a" /* APP_CONFIG */])),
...
/***/ "../../../../../src/app/pages/shared/services/paralament.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_config_interface__ = __webpack_require__("../../../../../src/app/app-config.interface.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_config_constants__ = __webpack_require__("../../../../../src/app/app-config.constants.ts");
...
let ParlamentService = class ParlamentService {
    constructor(http, helper, config) {
        this.http = http;
        this.helper = helper;
        this.config = config;
...
ParlamentService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["d" /* Injectable */])(),
    __param(2, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["g" /* Inject */])(__WEBPACK_IMPORTED_MODULE_6__app_config_constants__["a" /* APP_CONFIG */])),
...
/***/ "../../../../../src/app/pages/shared/services/queryBuilder.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
class QueryBuilder {
    constructor() { }
    queryFromPoliticianId(politicianId) {
        return `?politicianId=${politicianId}`;
    }
    queryFromPartyName(party) {
        return `?party=${party}`;
    }
}
...
/***/ "../../../../../src/app/pages/shared/services/sentiments.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_catch__ = __webpack_require__("../../../../rxjs/add/operator/catch.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_catch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_catch__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__model_rawsentiment_model__ = __webpack_require__("../../../../../src/app/pages/model/rawsentiment.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ramda__ = __webpack_require__("../../../../ramda/index.js");
...
let SentimentsService = class SentimentsService {
    ...
    getSentiments(query) {
        return this.http.get(`${this.config.BACKEND_URL}/sentiments${query}`)
            ...
            .map((sentiments) => __WEBPACK_IMPORTED_MODULE_8_ramda__["map"]((sentiment) => new __WEBPACK_IMPORTED_MODULE_7__model_rawsentiment_model__["a" /* RawSentiment */](sentiment.user.id, sentiment.tweet.sentiment.label, sentiment.tweet.sentiment.score, new Date(sentiment.createdAt)), sentiments))
            .catch(this.helper.handleError);
    }
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tile_tile_component__ = __webpack_require__("../../../../../src/app/pages/shared/tile/tile.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ng_bootstrap_ng_bootstrap__ = __webpack_require__("../../../../@ng-bootstrap/ng-bootstrap/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_app_pages_util_helper_service__ = __webpack_require__("../../../../../src/app/pages/util/helper.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__tile_tile_service__ = __webpack_require__("../../../../../src/app/pages/shared/tile/tile.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_paralament_service__ = __webpack_require__("../../../../../src/app/pages/shared/services/paralament.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__diagrams_sentiments_sentiments_component__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/sentiments/sentiments.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__diagrams_mentions_mentions_component__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/mentions/mentions.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_mentions_service__ = __webpack_require__("../../../../../src/app/pages/shared/services/mentions.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_sentiments_service__ = __webpack_require__("../../../../../src/app/pages/shared/services/sentiments.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__diagrams_sentiments_sentiments_transformer_service__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/sentiments/sentiments-transformer.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__diagrams_mentions_mentions_transformer_service__ = __webpack_require__("../../../../../src/app/pages/shared/diagrams/mentions/mentions-transformer.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__feed_feed_component__ = __webpack_require__("../../../../../src/app/pages/shared/feed/feed.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__seat_seat_component__ = __webpack_require__("../../../../../src/app/pages/shared/seat/seat.component.ts");
...
SharedModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_17__seat_seat_component__["a" /* SeatComponent */],
            __WEBPACK_IMPORTED_MODULE_3__tile_tile_component__["a" /* Tile */],
            __WEBPACK_IMPORTED_MODULE_10__diagrams_sentiments_sentiments_component__["a" /* SentimentsComponent */],
            __WEBPACK_IMPORTED_MODULE_11__diagrams_mentions_mentions_component__["a" /* MentionsComponent */],
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_16__feed_feed_component__["a" /* Feed */],
            __WEBPACK_IMPORTED_MODULE_17__seat_seat_component__["a" /* SeatComponent */],
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_8__tile_tile_service__["a" /* TileService */],
            __WEBPACK_IMPORTED_MODULE_9__services_paralament_service__["a" /* ParlamentService */],
            __WEBPACK_IMPORTED_MODULE_7_app_pages_util_helper_service__["a" /* Helper */],
            __WEBPACK_IMPORTED_MODULE_12__services_mentions_service__["a" /* MentionsService */],
            __WEBPACK_IMPORTED_MODULE_13__services_sentiments_service__["a" /* SentimentsService */],
            __WEBPACK_IMPORTED_MODULE_14__diagrams_sentiments_sentiments_transformer_service__["a" /* SentimentsTransformerService */],
            __WEBPACK_IMPORTED_MODULE_15__diagrams_mentions_mentions_transformer_service__["a" /* MentionsTransformerService */],
        ],
    })
], SharedModule);
...
/***/ "../../../../../src/app/pages/shared/tile/tile.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tile_service__ = __webpack_require__("../../../../../src/app/pages/shared/tile/tile.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_easy_pie_chart_dist_jquery_easypiechart_js__ = __webpack_require__("../../../../easy-pie-chart/dist/jquery.easypiechart.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__theme_theme_configProvider__ = __webpack_require__("../../../../../src/app/theme/theme.configProvider.ts");
...
let Tile = class Tile {
    constructor(_pieChartService, _baConfig) {
...
Tile = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Component */])({
        selector: 'tile',
        template: __webpack_require__("../../../../../src/app/pages/shared/tile/tile.html"),
        styles: [__webpack_require__("../../../../../src/app/pages/shared/tile/tile.scss")],
    }),
...
/***/ "../../../../../src/app/pages/shared/tile/tile.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_config_interface__ = __webpack_require__("../../../../../src/app/app-config.interface.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_config_interface___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__app_config_interface__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_config_constants__ = __webpack_require__("../../../../../src/app/app-config.constants.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__util_helper_service__ = __webpack_require__("../../../../../src/app/pages/util/helper.service.ts");
...
TileService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["d" /* Injectable */])(),
    __param(2, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["g" /* Inject */])(__WEBPACK_IMPORTED_MODULE_5__app_config_constants__["a" /* APP_CONFIG */])),
...
/***/ "../../../../../src/app/pages/util/helper.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapping__ = __webpack_require__("../../../../../src/app/pages/util/mapping.ts");
...
let Helper = class Helper {
    constructor(http) {
        ...
        this.destroyWidget = function () {
            __WEBPACK_IMPORTED_MODULE_4_jquery__('[class^=twitter-timeline]').remove();
        };
    }
    getUserByTwitterId(id) {
        return __WEBPACK_IMPORTED_MODULE_3__mapping__["a" /* MAPPING */].find((user) => user['id'] === id);
    }
    getUserByPersonId(id) {
        return __WEBPACK_IMPORTED_MODULE_3__mapping__["a" /* MAPPING */].find((user) => user['personId'] === id);
    }
    getIdsForParty(party) {
        return __WEBPACK_IMPORTED_MODULE_3__mapping__["a" /* MAPPING */].filter((p) => p.party === party).map((element) => element['personId']);
    }
    getIndexForPersonId(id) {
        return __WEBPACK_IMPORTED_MODULE_3__mapping__["a" /* MAPPING */].findIndex((obj) => obj['personId'] === id);
    }
    extractData(res) {
    ...
    reInitTwitterWidget(url) {
        this.destroyWidget();
        __WEBPACK_IMPORTED_MODULE_4_jquery__('.feed').append('<a class="twitter-timeline" href="' + url + '"></a>');
...
(function (root, factory) {
  if (true) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("../../../../jquery/dist/jquery.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function (a0) {
      return (factory(a0));
